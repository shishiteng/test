...
void ParseData(char chr)
{
    ...
    case 0x56:
        char *P = (char *)&sData[0];
        char *H = (char *)&sData[2];
        int pressure = (int)(P[3] << 24) + (int)(P[2] << 16) + (int)(P[1] << 8) + (int)P[0]; //（Pa）
        int height = (int)(H[3] << 24) + (int)(H[2] << 16) + (int)(H[1] << 8) + (int)H[0];   // cm
        printf("height: %d pressure: %d", height, pressure);
        break;
    }
    chrCnt = 0;
}
